...
def clean_html(html: str) -> str:
    ...
    Streamlit's markdown renderer treats any line indented with
    4+ spaces as a preformatted code block, even when
    unsafe_allow_html=True is set. Since HTML built with
    triple-quoted f-strings inside nested Python blocks inherits
    the surrounding source-code indentation, it gets rendered as
    literal text instead of actual HTML. Stripping each line's
    leading whitespace avoids that.
    """
